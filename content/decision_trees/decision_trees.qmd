...
Let's now train an example model for predicting the age of a possum from various features such as height and gender from the Kaggle [possum dataset](https://www.kaggle.com/datasets/abrambeyer/openintro-possum/data).
